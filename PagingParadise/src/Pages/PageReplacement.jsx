        ...
        >
          ...
          {chooseAlgo === 1 && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="min-h-[50vh] w-full  flex flex-col items-center gap-8"
            >
          ...
          {chooseAlgo === 2 && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="min-h-[50vh] w-full flex flex-col items-center justify-center gap-8"
            >
              <p className="text-3xl font-light  w-full text-center border-b-[3px] border-emerald-300 py-2">
          ...
          {chooseAlgo === 3 && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="min-h-[50vh] w-full flex flex-col justify-center items-center gap-8"
            >
              <p className="text-3xl font-light  w-full text-center border-b-[3px] border-emerald-300 py-2">
          ...
          <Visualize chooseAlgo={chooseAlgo} setchooseAlgo={setchooseAlgo} />
        </motion.div>
      </AnimatePresence>
    </div>
  );
