...
function ChooseAlgorithm(props) {
    ...
    return (
      <div
        className={`w-[30%] h-full bg-white shadow-inner rounded-lg overflow-hidden cursor-pointer duration-150 ease-linear   ${
          props.index === ind
            ? "bg-green-200/60 outline-emerald-300 outline"
  ...
  return (
    <div className="h-full w-full bg-gray-200/90 rounded-xl overflow-hidden flex flex-col gap-5">
      <div className="w-full h-[20%] flex justify-center items-center text-[1.8vw] bg-gradient-to-r from-slate-300 to-slate-500">
        Choose Algorithm
      </div>
